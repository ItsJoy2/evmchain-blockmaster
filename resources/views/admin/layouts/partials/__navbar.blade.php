								...
								<a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
									<div class="avatar-sm">
                                        ...
                                        @if($generalSettings && $generalSettings->favicon)
                                            <img src="{{ asset('storage/' . $generalSettings->favicon) }}" alt="{{ $generalSettings->app_name ?? '3twentyPay' }}" class="avatar-img rounded-circle">
                                        @endif
									</div>
...
{{--												<div class="avatar-lg"><img src="{{ Storage::url($generalSettings->favicon) }}" alt="image profile" class="avatar-img rounded"></div>--}}
												<div class="u-text">
													<a href="/admin/profile"><h4>{{ auth()->user()->name }}</h4></a>
